...
gr.Interface(fn=generate_image,
             ...
             outputs=["image",gr.Gallery(pr.galimg,
                                         label="Example output Images",show_label=True,height="700px",rows=2,columns=2,preview=False,show_share_button=True)],title="ImagTo",description="Let you imagination speak. Type what's on your mind and see the magic happen.",
