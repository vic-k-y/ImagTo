...
gr.Interface(fn=generate_image,
             ...
             outputs=["image",gr.Gallery(pr.galimg,
                                         label="Example output Images",show_label=False,height="auto",columns=2,preview=True,object_fit="contain",show_share_button=True)],title="ImagTo",description="Let you imagination speak. Type what's on your mind and see the magic happen.",
